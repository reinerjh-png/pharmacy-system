...
<head>
    ...
    <title><?= isset($pagina_titulo) ? htmlspecialchars($pagina_titulo) . ' - ' : '' ?><?= htmlspecialchars(FARMACIA_NOMBRE) ?></title>
    ...
    <link rel="stylesheet" href="<?= $base_url ?>/assets/css/layout.css?v=2.0">
    <link rel="stylesheet" href="<?= $base_url ?>/assets/css/components.css?v=2.0">

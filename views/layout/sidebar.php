...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        <?php if ($rol_id === 1): ?>
            <a href="<?= $base_url ?>/index.php" class="nav-item <?= ($current_page === 'index.php' && $current_dir === 'sys-farmacia') ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <?php if (in_array($rol_id, [1, 2])): ?>
            <a href="<?= $base_url ?>/modules/ventas/nueva_venta.php" class="nav-item <?= $current_page === 'nueva_venta.php' ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                </svg>
                Punto de Venta
            </a>
            <a href="<?= $base_url ?>/modules/ventas/historial.php" class="nav-item <?= $current_page === 'historial.php' ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="<?= $base_url ?>/modules/recetas/lista.php" class="nav-item <?= $current_dir === 'recetas' ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <?php if (in_array($rol_id, [1, 3])): ?>
            <a href="<?= $base_url ?>/modules/inventario/lista_productos.php" class="nav-item <?= ($current_dir === 'inventario' && $current_page !== 'alertas_vencimiento.php') ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a href="<?= $base_url ?>/modules/inventario/alertas_vencimiento.php" class="nav-item <?= $current_page === 'alertas_vencimiento.php' ? 'active' : '' ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
            </svg>
            Vencimientos
        </a>
        <a href="<?= $base_url ?>/modules/proveedores/lista.php" class="nav-item <?= $current_dir === 'proveedores' ? 'active' : '' ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a href="<?= $base_url ?>/modules/reportes/ventas_diarias.php" class="nav-item <?= $current_dir === 'reportes' ? 'active' : '' ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a href="<?= $base_url ?>/modules/usuarios/lista.php" class="nav-item <?= $current_dir === 'usuarios' ? 'active' : '' ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
